...
public static class PatientExtensions
{
    ...
    {
        return new Patient(viewModel.Name, viewModel.PhoneNumber, viewModel.SUSCard);
    }

    public static PatientDetailsViewModel ToDetailsViewModel(this Patient patient)
    {
        return new PatientDetailsViewModel(patient.Id, patient.Name, patient.PhoneNumber, patient.SUSCard);
    }
}
